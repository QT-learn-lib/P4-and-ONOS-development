...
public final class PipeconfLoader {
    ...
    public static final PiPipeconfId PIPECONF_ID = new PiPipeconfId("nextworking-ipv4-pipeconf");
    private static final URL P4INFO_URL = PipeconfLoader.class.getResource("/ipv4.p4info.txt");
    private static final URL BMV2_JSON_URL = PipeconfLoader.class.getResource("/ipv4.json");
